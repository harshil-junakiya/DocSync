    ...
    <div>
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          {
            isEdit
              ? <button onClick={updateProfile} className='px-4 py-1 border border-[#5f6fff] text-sm rounded-full mt-5 cursor-pointer hover:bg-[#5f6fff] hover:text-white tarnsition-all'>Save</button>
              : <button onClick={() => setIsEdit(true)} className='px-4 py-1 border border-[#5f6fff] text-sm rounded-full mt-5 cursor-pointer hover:bg-[#5f6fff] hover:text-white tarnsition-all'>Edit</button>
          }
        </div>
      </div>
    </div>
